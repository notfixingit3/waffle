...
<p align="center"><strong>Live Demo:</strong> [Coming Soon] | <strong>Latest Release:</strong> <a href="https://github.com/notfixingit3/waffle/releases/tag/v0.1.22-beta.3">v0.1.22-beta.3</a></p>
...
| Pinned | `v0.1.22-beta.3` | A specific stable version. Recommended for reproducible deployments. |
